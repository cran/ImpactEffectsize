...
ParetoRadiusIE <- function(Data ,maximumNrSamples = 10000, plotDistancePercentiles = FALSE){
...
ParetoDensityEstimationIE = function(Data,paretoRadius,kernels=NULL,MinAnzKernels=100,PlotIt=FALSE){
